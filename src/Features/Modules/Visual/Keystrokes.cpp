...
void Keystrokes::onRenderEvent(RenderEvent& event)
{
    ...
    // Get W center pos (only center x between box)
    {
        ...
        ImColor keyColor = mUseInterfaceColor.mValue ? ColorUtils::getThemedColor(wPos.x + wPos.y * 5) : ImColor(0, 0, 0, 200);
    ...
    // A (second row)
    {
        ...
        ImColor keyColor = mUseInterfaceColor.mValue ? ColorUtils::getThemedColor(aPos.x + aPos.y * 5) : ImColor(0, 0, 0, 200);
        if (mUseInterfaceColor.mValue) keyColor.Value.w = 200 / 255.f;
    ...
    // S (second row)
    {
        ...
        ImColor keyColor = mUseInterfaceColor.mValue ? ColorUtils::getThemedColor(sPos.x + sPos.y * 5) : ImColor(0, 0, 0, 200);
        if (mUseInterfaceColor.mValue) keyColor.Value.w = 200 / 255.f;
    ...
    // D (second row)
    {
        ...
        ImColor keyColor = mUseInterfaceColor.mValue ? ColorUtils::getThemedColor(dPos.x + dPos.y * 5) : ImColor(0, 0, 0, 200);
        if (mUseInterfaceColor.mValue) keyColor.Value.w = 200 / 255.f;
    ...
    // SPACE (third row)
    {
        ...
        ImColor keyColor = mUseInterfaceColor.mValue ? ColorUtils::getThemedColor(spacePos.x + spacePos.y * 5) : ImColor(0, 0, 0, 200);
        if (mUseInterfaceColor.mValue) keyColor.Value.w = 200 / 255.f;
