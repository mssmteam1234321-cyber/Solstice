...
void Keystrokes::onRenderEvent(RenderEvent& event)
{
    ...
    // Get W center pos (only center x between box)
    {
        ...
        drawList->AddRectFilled(wPosCenter - scaledW / 2, wPosCenter + scaledW / 2, IM_COL32(255, 255, 255, 150 * keyAnimation[0]), rounding * keyAnimation[0]);
    ...
    // A (second row)
    {
        ...
        drawList->AddRectFilled(aPosCenter - scaledA / 2, aPosCenter + scaledA / 2, IM_COL32(255, 255, 255, 150 * keyAnimation[2]), rounding * keyAnimation[2]);
    ...
    // S (second row)
    {
        ...
        drawList->AddRectFilled(sPosCenter - scaledS / 2, sPosCenter + scaledS / 2, IM_COL32(255, 255, 255, 150 * keyAnimation[1]), rounding * keyAnimation[1]);
    ...
    // D (second row)
    {
        ...
        drawList->AddRectFilled(dPosCenter - scaledD / 2, dPosCenter + scaledD / 2, IM_COL32(255, 255, 255, 150 * keyAnimation[3]), rounding * keyAnimation[3]);
    ...
    // SPACE (third row)
    {
        ...
        drawList->AddRectFilled(spacePosCenter - scaledSpace / 2, spacePosCenter + scaledSpace / 2, IM_COL32(255, 255, 255, 150 * keyAnimation[4]), rounding * keyAnimation[4]);
