...
public:
    ...
    DEFINE_INDEX_FIELD(MinecraftGame_mMouseGrabbed, "80 B9 ? ? ? ? ? 0F 84 ? ? ? ? 48 8B 01 48 8B 80 ? ? ? ? FF 15 ? ? ? ? 48 85 C0", 2, OffsetType::FieldOffset); // TODO: Replace with better sig :3
    ...
    DEFINE_INDEX_FIELD(MinecraftSim_mGameSession, "48 8B 89 ? ? ? ? 45 33 F6 48 8B FA", 3, OffsetType::FieldOffset); // TODO: Replace with better sig :3
    ...
    DEFINE_INDEX_FIELD_TYPED(uint8_t, ContainerManagerModel_getSlot, "48 8B 40 ? FF 15 ? ? ? ? 48 8B D8 8B 56 ? 0F B6 4E ? 45 33 FF 44 89 BD ? ? ? ? 88 8D ? ? ? ? 0F B7 4C 24 ? 66 89 8D ? ? ? ? 0F B6 4C 24 ? 88 8D ? ? ? ? 44 89 BD ? ? ? ? 89 95 ? ? ? ? 48 8B D0 48 8D 8D ? ? ? ? E8 ? ? ? ? 90 48 8D 95 ? ? ? ? 48 8D 8D ? ? ? ? E8 ? ? ? ? 90 48 8B D3 48 8D 8D ? ? ? ? E8 ? ? ? ? 4C 8D 2D ? ? ? ? 4C 89 AD ? ? ? ? 44 89 BD ? ? ? ? 44 88 BD ? ? ? ? 48 8D 93 ? ? ? ? 48 8D 8D ? ? ? ? E8 ? ? ? ? 90 48 8D 95 ? ? ? ? 48 8D 8D ? ? ? ? E8 ? ? ? ? 4C 89 AD ? ? ? ? 44 89 BD ? ? ? ? 44 88 BD ? ? ? ? 48 8D 95 ? ? ? ? 48 8D 8D ? ? ? ? E8 ? ? ? ? 90 48 8D 95", 3, OffsetType::Index); // what the actual fcuk is wrong with me.
    DEFINE_INDEX_FIELD(Level_getPlayerMovementSettings, "48 8B 80 ? ? ? ? FF 15 ? ? ? ? 49 8B 7E ? 80 78", 3, OffsetType::Index);
    DEFINE_INDEX_FIELD(Actor_mSerializedSkin, "48 89 ? ? ? 56 48 83 EC ? 8B 41 ? 48 8D", 3, OffsetType::FieldOffset); // TODO: Check this and replace the sig with a better one :3
