...
public:
    ...
    DEFINE_INDEX_FIELD_TYPED(uint8_t, Container_getItem, "48 8B ? ? FF 15 ? ? ? ? 4C 8B ? 41 80 7D 23", 3, OffsetType::Index);
    ...
    DEFINE_FIELD(Actor_mLocalName, 0xC88);
    DEFINE_FIELD(ClientInstance_mViewMatrix, 0x330);
