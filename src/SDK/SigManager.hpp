...
public:
    ...
    DEFINE_SIG(InventoryTransaction_addAction, "E8 ? ? ? ? 48 81 C3 ? ? ? ? 48 3B DD 75 ? BD", SigType::RefSig, 1);
    ...
    DEFINE_SIG(CameraComponent_applyRotation, "66 0F ? ? 0F 5B ? 0F 2F ? 76 ? F3 0F", SigType::Sig, 0); // Guessed func name
