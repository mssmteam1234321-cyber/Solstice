...
struct CanJoinRaidFlagComponent {}; // string: auto __cdecl entt::internal::stripped_type_name<struct CanJoinRaidFlagComponent>(void) noexcept
...
struct ActorChunkMoveFlagComponent {}; // string: auto __cdecl entt::internal::stripped_type_name<struct ActorChunkMoveFlagComponent>(void) noexcept
